        ...
        <div className="bg-white border-2 border-lorcana-gold border-t-0 rounded-b-sm shadow-lg p-3 sm:p-6">
          ...
          <div className="hidden md:block">
            <div className="flex flex-wrap items-stretch gap-2 justify-center lg:justify-center xl:justify-center">
              <div className="w-[400px] flex">
                ...
                <select
                  ...
                  className="h-[42px] px-4 border-2 border-lorcana-gold rounded-sm focus:ring-2 focus:ring-lorcana-gold focus:border-lorcana-navy bg-white hover:bg-lorcana-cream transition-colors"
                >
            ...
            >
              ...
              className={`h-[42px] px-3 border-2 rounded-sm focus:ring-2 focus:ring-lorcana-gold transition-colors ${
                showFilterNotification 
              ...
              title={showFilterNotification ? 'Refresh view to apply current filters' : 'No stale cards to refresh'}
                ...
                <button
                  onClick={() => setShowFilters(!showFilters)}
              className={`h-[42px] px-4 border-2 rounded-sm focus:ring-2 focus:ring-lorcana-gold flex items-center space-x-2 transition-colors ${
                activeFiltersCount > 0 ? 'bg-lorcana-gold border-lorcana-navy text-lorcana-ink' : 'border-lorcana-gold hover:bg-lorcana-cream'
              }`}
                >
                  <Filter size={18} />
                  <span>Filters</span>
                  {activeFiltersCount > 0 && (
                    <span className="bg-lorcana-navy text-lorcana-gold text-xs font-bold px-2 py-0.5 rounded-sm">
                      {activeFiltersCount}
                    </span>
                  )}
                </button>
                <button
                  ...
                  className="h-[42px] px-4 border-2 border-lorcana-gold rounded-sm hover:bg-lorcana-cream focus:ring-2 focus:ring-lorcana-gold transition-colors"
                >
